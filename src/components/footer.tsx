      ...
      <div className='px-6 md:px-12 py-8 bg-[#2A254B] mt-8'>
        <div className="flex flex-wrap gap-12 md:gap-[100px] lg:gap-[200px]">
          ...
          <div className="text-white w-full sm:w-auto">
            <h1 className="text-lg md:text-xl text-green-100 font-bold">Join our mailing list</h1>
            <div className='mt-4'>
              <input
                type="text"
        ...
        <hr className='bg-[#2A254B] my-8' />

        {/* Footer Bottom Section */}
        <div className='flex flex-wrap justify-between items-center text-gray-100 gap-4'>
          <div>
